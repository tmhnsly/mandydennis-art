  ...
  return (
    <nav className="sticky top-0 z-50 bg-bg/90 backdrop-blur-xl">
      <div className="max-w-[var(--width-content)] mx-auto flex items-center justify-between px-[var(--pad-page)] py-2">
        <NavLink
          to="/"
          className="font-display font-bold text-[1.05rem] tracking-tight text-text min-h-11 flex items-baseline gap-1"
        >
          Mandy <span className="font-serif italic font-normal text-text-mid text-[1.15rem]">Dennis</span>
        </NavLink>
