...
const TAG_BASE = "inline-flex items-center justify-center gap-1.5 min-h-11 px-5 rounded-full text-[0.78rem] font-medium border transition-colors cursor-pointer";
